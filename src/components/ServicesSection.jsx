...
export default function ServicesSection() {
  ...
  return (
    <section id="services" className="relative py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-white overflow-hidden scroll-mt-20">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-bold text-forest-green mb-6 tracking-tight">
            核心服務項目
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 items-start">
          {services.map((service) => {
            ...
            return (
              ...
              >
                <div className={`
                  bg-white rounded-3xl p-6 md:p-8 h-full flex flex-col transition-all duration-300 border
                  ${isExpanded ? 'shadow-2xl border-forest-green/20' : 'shadow-sm border-gray-100 hover:shadow-md'}
                `}>
                  ...
                  {/* Title & Description */}
                  <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-3 break-words leading-snug">
                    {service.title}
                  </h3>
                  ...
                  <div className="mt-8 pt-6 border-t border-gray-50">
                    <button 
                      ...
                      className="text-forest-green hover:text-ocean-blue font-bold text-sm flex items-center w-full justify-between py-2 -my-2 transition-colors"
